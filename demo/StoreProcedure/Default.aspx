...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="text-start">
            ...
            <asp:Label ID="Label5" runat="server" Text="Jaydip"></asp:Label>
            <br />
        <table class="w-100">
            <tr>
            ...
            <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" BackColor="Blue" ForeColor="White" OnClick="Button1_Click" Text="Update" Width="90px" />
&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" BackColor="Red" ForeColor="White" OnClick="Button2_Click" Text="Delete" OnClientClick="return confirm ('Are you sure ? ')" Width="90px" />
                &nbsp;&nbsp;
                    <asp:Button ID="Button4" runat="server" BackColor="Black" ForeColor="White" OnClick="Button4_Click" Text="Load" Width="90px" />
                &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Reset" Width="90px" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
